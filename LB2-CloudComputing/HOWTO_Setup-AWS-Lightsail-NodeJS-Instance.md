# HOWTO: Create an Amazon Lightsail NodeJS server instance> 
...
1. On your instance management page, under the **Networking** tab, choose **Create static IP**, then follow the instructions on the page\.
...
### Step 4: Read the Bitnami documentation<a name="amazon-lightsail-nodejs-read-the-bitnami-documentation"></a>
...
### Step 5: Create a snapshot of your Node\.js instance<a name="amazon-lightsail-nodejs-create-a-snapshot"></a>
...
1. Under the **Snapshot** tab of your instance’s management page, enter a name for the snapshot, then choose **Create snapshot**\.
...
---
## Optional: Map your domain name to your Node\.js instance<a name="amazon-lightsail-nodejs-map-your-domain-to-your-instance"></a>
